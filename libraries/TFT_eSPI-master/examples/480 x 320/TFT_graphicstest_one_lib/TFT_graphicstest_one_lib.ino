...
unsigned long testText() {
  ...
  tft.setTextSize(5);
  tft.println("My arduino");
  tft.setTextSize(2);
  tft.println("We are large online store");
  tft.setTextSize(2);
  tft.println("We are selling electronics");
  //tft.setTextColor(TFT_GREEN,TFT_BLACK);
  tft.setTextSize(1);
  tft.println("We are sell the arduino board.");
  tft.println("Reaspbarry Pi");
  tft.println("Node MCU ESP8266 & ESP32,");
  tft.println("and many other devices");
  tft.println("Fast delivery and 100% quality assured !!!");
  tft.println("Think of electronics, think of us,");
  tft.println("www.myarduino.net");
  return micros() - start;
}
